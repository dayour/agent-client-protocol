...
export type SessionConfigOptionCategory =
  "mode" | "model" | "model_config" | "thought_level" | Other3;
/**
 ...
 */
export type McpServer = McpServerHttp | McpServerSse | Stdio;
/**
...
export interface AgentNotification {
   ...
   */
  params?:
    | (SessionNotification | CompleteElicitationNotification | ExtNotification)
    | null;
}
/**
...
export interface ClientNotification {
   ...
   * Method-specific notification parameters.
   */
  params?: (CancelNotification | ExtNotification2) | null;
}
/**
